...
Join the community at https://chatenvia.com/community?utm_source=cwctl
***************************************************************************
...
function get_cw_version() {
  CW_VERSION=$(curl -s https://app.chatenvia.com/api | python3 -c 'import sys,json;data=json.loads(sys.stdin.read()); print(data["version"])')
}
...
https://www.chatenvia.com/docs/deployment/deploy-chatwoot-in-linux-vm?utm_source=cwctl
...
Get help, https://chatenvia.com/community?utm_source=cwctl
